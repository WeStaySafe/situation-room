...
#
#     PHX_SERVER=true bin/situation_room start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :situation_room, SituationRoomWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  host = System.get_env("PHX_HOST") || "westaysafe.com"
  ...
  #
  #     config :situation_room, SituationRoom.Mailer,
